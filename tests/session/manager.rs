...
fn compaction_preserves_messages_after_cut_point() {
    ...
    mgr.append_compaction("summary of 0-6".into(), entry7_id, 3000, 0, String::new(), vec![]).unwrap();
...
fn compaction_survives_reload() {
    ...
    mgr.append_compaction("summary".into(), entry5_id, 2000, 0, String::new(), vec![]).unwrap();
...
fn compaction_with_tool_calls_across_boundary() {
    ...
    mgr.append_compaction("old conversation summary".into(), cut_id, 1000, 0, String::new(), vec![]).unwrap();
...
fn compaction_only_removes_current_branch_entries() {
    ...
    mgr.append_compaction("summary of A".into(), branch_a_keep_id.clone(), 500, 0, String::new(), vec![]).unwrap();
...
fn compaction_removes_pre_cut_entries_on_current_branch() {
    ...
    mgr.append_compaction("summary".into(), cut_id, 1000, 0, String::new(), vec![]).unwrap();
...
fn compaction_removes_fts_entries() {
    ...
    mgr.append_compaction("summary".into(), kept_id, 1000, 0, String::new(), vec![]).unwrap();
