...
pub trait AgentTool: Send + Sync {
    ...
    /// Whether this tool only reads state and never mutates files or system state.
    /// Read-only tools are safe to run in parallel. Default: false.
