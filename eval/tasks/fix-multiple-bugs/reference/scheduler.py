"""Reference implementation — all 4 bugs fixed."""
...
class Scheduler:
    ...
    def next_task(self):
        ...
        if not pending:
            return None
        # FIX 2: sort descending (reverse=True) to get highest priority
    ...
    def summary(self):
        ...
        # FIX 3: was already float division in Python 3, no change needed
    ...
    def bulk_add(self, task_defs):
        ...
        for name, priority in task_defs:
            ...
            count += 1  # FIX 4: was missing increment
        return count
